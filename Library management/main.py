...
headingLabel = Label(headingFrame1, text="Welcome To \n Hierank Library Management", bg='black', fg='white', font=('Courier',15))
...
exit_button.place(relx=0.85,rely=0.9, relwidth=0.10,relheight=0.1)
